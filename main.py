...
parser.add_argument('-sc', '--split_collections', help='Split outgoing files on main collections into different files',
                    type=bool, action=argparse.BooleanOptionalAction)
parser.add_argument('-st', '--stats', help='Show statistics of ram usage and more',
                    type=bool, action=argparse.BooleanOptionalAction)
...
class Converter:
    def __init__(self):
        ...
        while True:
            ...
            if os.path.exists(self.file_name):
                ...
                print('File not found, please provide a existing jsonl file', flush=True)
    ...
    def start(self):
        ...
        with open(self.file_name, 'r+', encoding='utf-8') as f:
            for round in self.progressbar(rounds, 'Progress: ', 40):
                ...
                data = [json.loads(line)
                        for line in islice(f, self.round_line)]
        ...
        if (self.split_collections == True):
            ...
            for key in file_data.keys():
                ...
                with open(self.output_folder + key + ".json", 'w', encoding='utf-8') as file:
                    if self.format_output == True:
                        json.dump(file_data[key], file,
        ...
        if (self.stats == False or self.stats == None):
    ...
    def return_statistics(self):
        ...
        print("Lines converted/s: ", math.floor(self.line_count /
    ...
    def progressbar(self, it, prefix='', size=60, out=sys.stdout):
        ...
        def show(j):
            ...
            """
            x = size * j // count
            if (self.stats == True and self.max_ram_usage < psutil.virtual_memory().used):
                self.max_ram_usage = psutil.virtual_memory().used
